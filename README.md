...
- Strava has no activity deletion API. “Continue to upload” checks the originals and opens
  ...
  Strava, and explicit confirmation are required. The final “Verify and upload to Strava”
  submission checks that the originals are unavailable, then starts the upload without
  another confirmation screen. Stitch never deletes Strava activities.
